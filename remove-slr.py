"""
Remove any scraper data for a site that came from SLR instead of the site "proper."
Useful if a native scraper is introduced, but existing scene data comes from SLR, 
and like, you want to unmatch those so you can re-match them with the main scraper, 
and user SLR as an alt site.  Or something.  I mean, that's what I used it for.
You do you.
"""
...
if __name__ == "__main__":
	...
	print(f"Asking XBVR for SLR listings for {site_name}...")
